...
//column	    	    
	...
	public void xgoogle() throws InterruptedException {
		...
		// d.findElements(By.xpath("//ul[@role='listbox']//li/descendant::div[@class='lnnVSe']"));
		List<WebElement> listelement = d.findElements(By.xpath("//ul[@role='listbox']//li"));
		Thread.sleep(2000);

		System.out.println("all the suggestions = " + listelement.size());
		for (int i = 0; i < listelement.size(); i++) {
			System.out.println(listelement.get(i).getText());
			if (listelement.get(i).getText().contains("selenium rich foods")) {
